...
public class EntityParser {
	...
	public EntityParser(Class table) {
		if (!table.isAnnotationPresent(Entity.class) || !table.isAnnotationPresent(javax.persistence.Table.class)) throw new AnnotationFormatError("The class hasn't got Entity or Table annotation!");
