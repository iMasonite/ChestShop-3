...
public class ValueParser {
	...
	public static String parseToYAML(Object object) {
		if (object instanceof Number || object instanceof Boolean) return String.valueOf(object);
	...
	public static Object parseToJava(Object object) {
		...
		else if (object instanceof String) return Configuration.getColoured((String) object);
		else return object;
	}
}
